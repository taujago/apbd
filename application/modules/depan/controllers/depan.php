...
class depan extends master_controller  {
	...
	function depan(){
		...
		$this->load->model("depan_model","dm");
	...
	function index(){
		...
		$pendapatan = $this->dm->get_total_pembiayaan();

		// echo "pendapatan". $pendapatan; exit; 
		$arr_data['pendapatan'] = number_format($pendapatan,0,".",",");

		$penerimaan_pembiayaan = $this->dm->get_penerimaan_pembiayaan();
		$arr_data['penerimaan_pembiayaan'] = number_format($penerimaan_pembiayaan,0,".",",");
...
function grafik_belanja(){
		...
		$this->load->view("dashboard_graphic_belanja",$arr);
...
function grafik_penerimaan_pembiayaan(){
		...
		$this->load->view("dashboard_graphic_penerimaan_pembiayaan",$arr);
	}
