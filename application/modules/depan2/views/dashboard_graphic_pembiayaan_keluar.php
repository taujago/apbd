...
<div id='chart_pembiayaan_keluar' class='chart' style='height: 400px;'>Anggaran Kegiatan</div>
<script>
 
var initChartPembiayaanKeluar = function() {
                        var chart = AmCharts.makeChart('chart_pembiayaan_keluar', {
                            'type': 'pie',
                            'theme': 'light',
